...
// CRC
const ROOTS_CHECKIN = '/checkin';
const ROOTS_REPORTS = '/reports';
const ROOTS_PICKING = '/picking';
const ROOTS_SORTER = '/sorter';
const ROOTS_SHIFT = '/shift';
const ROOTS_ASSOCIATETYPE = '/associate-type';
...
export const PATH_APP = {
  ...
  reports: ROOTS_REPORTS,
  picking: ROOTS_PICKING,
  sorter: ROOTS_SORTER,
  checkin: ROOTS_CHECKIN,
  shift: ROOTS_SHIFT,
  associateType: ROOTS_ASSOCIATETYPE,
  attendance: ROOTS_ATTENDANCE,
  user: ROOTS_USER
};
